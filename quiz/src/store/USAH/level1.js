const QUESTION_U1 =
  [{id:'1usa1',
    ...
    correctanswer:'When a player of a team shoots, bats with the hand or stick or deflects the puck from his own half of the ice completely beyond the goal line of the opposing team',
    incorrectanswers: [
